...
| Registry unit | **236 tests**, 11 files | nothing, in-process server with a stub ledger |
...
976 lines of production Daml, 2508 lines of Daml tests, 1820 lines of
TypeScript service, 4609 lines of TypeScript tests, each figure a
...
cd registry && npm install && npm test   # 236 unit tests, no ledger needed
