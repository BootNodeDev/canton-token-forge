...
checked against the tree at commit `6f9b995`.
...
All three suites were re-run at commit `6f9b995`, exit 0:

| Suite | Result | Needs |
|---|---|---|
| Daml Script | **60 scenarios**, 11 modules | nothing, runs in-process |
| Registry unit | **165 tests**, 10 files | nothing, in-process server with a stub ledger |
...
service, 3516 lines of TypeScript tests. MIT licensed. Pre-release: the package
...
cd registry && npm install && npm test   # 165 unit tests, no ledger needed
